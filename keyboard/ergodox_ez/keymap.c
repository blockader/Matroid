...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_NORM_BASE] = KEYMAP_PERMUTE(
        ...
        KEY_LEFT_COMMAND, KEY_LEFT_CONTROL, KC_LALT, KC_AT, KC_SPC,
        KC_NO, KC_NO,
        KC_NO,
        KC_LBRC, KC_NO, KC_NO,
        ...
        KC_BSPC, KC_NO, KC_RALT, KEY_RIGHT_CONTROL, KEY_RIGHT_COMMAND,
        KC_NO, KC_NO,
        KC_NO,
        KC_NO, KC_NO, KC_LPRN
    ),
    [LAYER_NORM_EXTENSION] = KEYMAP_PERMUTE(
        ...
        KEY_CREATE_NEXT_LINE, KC_CIRC, KC_AMPR, KC_PIPE, KC_QUES, KC_PERC, KC_NO,
        KEY_FORWARD_LAYER(LAYER_NORM_EXTENSION), KEY_MOVE_PREVIOUS_WORD, KEY_MOVE_NEXT_WORD, KEY_DELETE_LINE, KEY_MOVE_LINE_STRAT, KEY_MOVE_LINE_END,
        KC_LSFT, KC_DLR, KC_HASH, KC_BSLS, KC_TILD, KC_UNDS, KC_NO,
        KEY_LEFT_COMMAND, KEY_LEFT_CONTROL, KC_LALT, KC_NO, KC_TAB,
        KC_NO, KC_NO,
        KC_NO,
        KC_RBRC, KC_NO, KC_NO,
        ...
        KC_NO, KC_SLSH, KC_ASTR, KC_LT, KC_GT, KC_DQUO, KC_RSFT,
        KEY_DELETE_WORD, KC_NO, KC_RALT, KEY_RIGHT_CONTROL, KEY_RIGHT_COMMAND,
        KC_NO, KC_NO,
        KC_NO,
        KC_NO, KC_NO, KC_RPRN
    ),
