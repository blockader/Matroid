...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_NORM_BASE] = KEYMAP_PERMUTE(
        ...
        KEY_LEFT_COMMAND, KEY_LEFT_CONTROL, KC_LALT, KC_AT, KC_BSPC,
        KC_NO, KC_NO,
        KC_NO,
        KC_LBRC, KC_NO, KC_NO,
        ...
        KC_SPC, KC_NO, KC_RALT, KEY_RIGHT_CONTROL, KEY_RIGHT_COMMAND,
        KC_NO, KC_NO,
        KC_NO,
        KC_NO, KC_NO, KC_LPRN
    ),
    [LAYER_NORM_EXTENSION] = KEYMAP_PERMUTE(
        ...
        KEY_LEFT_COMMAND, KEY_LEFT_CONTROL, KC_LALT, KC_NO, KEY_DELETE_WORD,
        KC_NO, KC_NO,
        KC_NO,
        KC_RBRC, KC_NO, KC_NO,
        ...
        KC_TAB, KC_NO, KC_RALT, KEY_RIGHT_CONTROL, KEY_RIGHT_COMMAND,
        KC_NO, KC_NO,
        KC_NO,
        KC_NO, KC_NO, KC_RPRN
    ),
