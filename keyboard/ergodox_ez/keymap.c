...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_NORM_BASE] = KEYMAP_PERMUTE(
        ...
        KC_ASTR, KC_Z, KC_X, KC_C, KC_V, KC_B, LGUI(LSFT(KC_4)), LOPT(KC_SPC), KC_K, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_AMPR,
    ...
    [LAYER_NORM_EXTENSION] = KEYMAP_PERMUTE(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KEY_DELETE_LINE, KEY_FORWARD_LAYER(LAYER_OS), KC_NO, LCTL(KC_C), LGUI(KC_W), LGUI(KC_T), KC_VOLD, KC_VOLU, KC_MPLY,
        KC_RBRC, KC_DLR, KC_HASH, KC_CIRC, KC_QUES, KC_PERC, KEY_FORWARD_LAYER(LAYER_RACE_BASE), KEY_FORWARD_LAYER(LAYER_LEGACY_BASE), KC_GRAVE, KC_EXLM, KC_TILD, KC_AT, KC_COLN, KC_RPRN,
        KC_RCBR, LALT(KC_LEFT), LALT(KC_RIGHT), KC_EQL, KEY_MOVE_LINE_STRAT, LCTL(KC_E), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_BSLS, KC_MINUS,
        KC_SLSH, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), KEY_PASTE, LGUI(KC_A), KC_NO, KC_NO, LGUI(KC_S), KC_UNDS, KC_LT, KC_GT, KC_DQUO, KC_PIPE,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KEY_CREATE_NEXT_LINE, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_RSFT, KEY_DELETE_WORD
    ),
    ...
    [LAYER_RACE_EXTENSION] = KEYMAP_PERMUTE(
        ...
        KC_RBRC, KC_DLR, KC_HASH, KC_CIRC, KC_QUES, KC_PERC, KEY_BACK_LAYER, KC_NO, KC_GRAVE, KC_EXLM, KC_TILD, KC_AT, KC_COLN, KC_RPRN,
        KC_RCBR, KC_NO, KC_NO, KC_EQL, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_BSLS, KC_MINUS,
        KC_SLSH, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_UNDS, KC_LT, KC_GT, KC_DQUO, KC_PIPE,
    ...
    [LAYER_LEGACY_BASE] = KEYMAP_PERMUTE(
        ...
        KC_ASTR, KC_Z, KC_X, KC_C, KC_V, KC_B, LGUI(LSFT(KC_4)), LOPT(KC_SPC), KC_N, KC_M, KC_COMM, KC_DOT, KC_QUOT, KC_AMPR,
        KEY_LEFT_COMMAND, KC_LCTL, KC_LALT, LCTL(KC_SPC), KC_TAB, KC_ENT, KC_CAPS, KC_RALT, KC_RCTL, KEY_RIGHT_COMMAND,
        KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO,
    ...
    [LAYER_LEGACY_EXTENSION] = KEYMAP_PERMUTE(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KEY_DELETE_LINE, KEY_FORWARD_LAYER(LAYER_OS), KC_NO, LCTL(KC_C), LGUI(KC_W), LGUI(KC_T), KC_VOLD, KC_VOLU, KC_MPLY,
        KC_RBRC, KC_DLR, KC_HASH, KC_CIRC, KC_QUES, KC_PERC, KC_NO, KEY_BACK_LAYER, KC_GRAVE, KC_EXLM, KC_TILD, KC_AT, KC_COLN, KC_RPRN,
        KC_RCBR, LALT(KC_LEFT), LALT(KC_RIGHT), KC_EQL, KEY_MOVE_LINE_STRAT, LCTL(KC_E), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_BSLS, KC_MINUS,
        KC_SLSH, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), KEY_PASTE, LGUI(KC_A), KC_NO, KC_NO, LGUI(KC_S), KC_UNDS, KC_LT, KC_GT, KC_DQUO, KC_PIPE,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KEY_CREATE_NEXT_LINE, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO,
