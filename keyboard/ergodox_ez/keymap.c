...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_NORM_EXTENSION] = KEYMAP_PERMUTE(
        ...
        KC_RBRC, KC_CIRC, KC_QUES, KC_PERC, KC_DLR, KC_HASH, KEY_FORWARD_LAYER(LAYER_RACE_BASE), KEY_FORWARD_LAYER(LAYER_LEGACY_BASE), KC_GRAVE, KC_EXLM, KC_TILD, KC_AT, KC_COLN, KC_RPRN,
    ...
    [LAYER_RACE_EXTENSION] = KEYMAP_PERMUTE(
        ...
        KC_RBRC, KC_CIRC, KC_QUES, KC_PERC, KC_DLR, KC_HASH, KEY_BACK_LAYER, KC_NO, KC_GRAVE, KC_EXLM, KC_TILD, KC_AT, KC_COLN, KC_RPRN,
    ...
    [LAYER_LEGACY_EXTENSION] = KEYMAP_PERMUTE(
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KEY_FORWARD_LAYER(LAYER_OS), KC_NO, LCTL(KC_C), LGUI(KC_W), LGUI(KC_T), KC_VOLD, KC_VOLU, KC_MPLY,
        KC_RBRC, KC_CIRC, KC_QUES, KC_PERC, KC_DLR, KC_HASH, KC_NO, KEY_BACK_LAYER, KC_GRAVE, KC_EXLM, KC_TILD, KC_AT, KC_COLN, KC_RPRN,
        KC_RCBR, LALT(KC_LEFT), LALT(KC_RIGHT), KC_EQL, KEY_MOVE_LINE_STRAT, LCTL(KC_E), KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_BSLS, KC_MINUS,
        KC_SLSH, LGUI(KC_Z), LGUI(KC_X), LGUI(KC_C), KEY_PASTE, LGUI(KC_A), KC_NO, KC_NO, LGUI(KC_S), KC_UNDS, KC_LT, KC_GT, KC_DQUO, KC_PIPE,
        KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KEY_CREATE_NEXT_LINE, KC_NO, KC_NO, KC_NO, KC_NO,
        KC_NO, KC_NO, KC_NO, KC_NO,
